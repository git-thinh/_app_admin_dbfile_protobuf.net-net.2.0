...
namespace Deveck.Ui.Controls.Scrollbar
{
    public class CustomScrollbar : Control, ICustomScrollbar
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            _upperButtonPainter.Paint(e.Graphics, upperButton, _upperButtonState, "", null, Font, null);
            _lowerButtonPainter.Paint(e.Graphics, lowerButton, _lowerButtonState, "", null, Font, null);

            if(_currentThumbPosition.Height > 0)
                GetThumbPainter().Paint(e.Graphics, _currentThumbPosition, _thumbState, "", null, Font, null);
        }
