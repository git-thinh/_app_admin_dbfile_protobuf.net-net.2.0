...
namespace Sano.PersonalProjects.ColorPicker.Controls
{
    ...
    internal class ColorSwatchPanel : System.Windows.Forms.Panel
    {
        ...
        {
            string resourceName = ___Const_ColorPicker.Path_Resource + "ColorSwatches.xml";
            var assembly = Assembly.GetExecutingAssembly();
            //resourceName = typeof(App).Namespace + "." + resourceName.Replace(" ", "_").Replace("\\", ".").Replace("/", ".");
            using (Stream stream = assembly.GetManifestResourceStream(resourceName))
            {
                StreamReader fileStreamRead = new StreamReader(stream);
                //StreamReader fileStreamRead = new StreamReader(Resources.GetFileResource("app.GUI.Controls.ColorPicker.ColorSwatches.xml"));
