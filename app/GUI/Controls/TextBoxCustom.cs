...
namespace app.GUI
{
    public class TextBoxCustom : TextBox
    {
        ...
        private void Initialize()
        {
            ...
            _waterMarkActiveColor = Color.OrangeRed;
            ///waterMarkFont = this.Font;
            waterMarkFont = new Font("Microsoft Sans Serif", 7.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
        ...
        private void waterMarkContainer_Paint(object sender, PaintEventArgs e)
        {
            ...
            //waterMarkContainer.BackColor = Color.Gray;
            waterMarkContainer.Location = new Point(4, 1); // sets the location
            waterMarkContainer.Height = this.Height - 4; // Height should be the same as its parent
            waterMarkContainer.Width = this.Width - 6; // same goes for width and the parent
